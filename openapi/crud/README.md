...
- __PUT__: /api/v1/parks/:id - Edits park with id
...
#### Edits park with id
To keep the example simple, all values are mandatory. Otherwise, you can create a new model with optional values.
